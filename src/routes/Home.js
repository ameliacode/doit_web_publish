const Home = () => {
    return(
        <section className="w-full h-full relative max-w-[1200px] mx-auto">
            <section className="
             w-[25%] h-full absolute top-0 left-0 bg-menu1-image bg-repeat border-r-[1px] border-black">
            ...
            <section className="w-[25%] h-full absolute top-0 left-[25%] bg-menu2-image bg-repeat border-r-[1px] border-black">
            ...
            <section className="w-[25%] h-full absolute top-0 left-[50%] bg-menu3-image bg-repeat border-r-[1px] border-black">
            ...
            <section className="w-[25%] h-full absolute top-0 left-[75%] bg-menu4-image bg-repeat">
